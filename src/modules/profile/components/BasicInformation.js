        ...
        return (
            <React.Fragment>
                <MDBCol md="3">
                    ...
                    <input disabled={flagInformation} type="file" name='picture' id="upload-photo" onChange={this.onImageChange} />
                ...
                <MDBCol md="7">
                    ...
                    <MDBCol className="text-center">
                        <MDBBtn disabled={flagInformation} onClick={() => onSave(this.state)} color="success" className="btn btn-circle mt-4 mb-5">
                            Save
                        </MDBBtn>
                        <MDBBtn disabled={flagInformation} onClick={onCancel} color="danger" className="btn btn-circle mt-4 mb-5">
                            Cancel
                        </MDBBtn>
                    </MDBCol>
                </MDBCol>
