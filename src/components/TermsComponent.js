...
const TermsConditions = () => (
  <>
    ...
    <p>Last updated: June 07, 2016</p>
    <p>
      {`Please read these Terms and Conditions ("Terms", "Terms and Conditions")
      carefully before using the Bazl mobile application (the "Service")
      operated by Bazl LLC ("us", "we", or "our").`}
    </p>
    <p>
    ...
    <h2 className="p-3">Communications</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;By creating an Account on our service, you
      agree to subscribe to newsletters, marketing or promotional materials and
      other information we may send. However, you may opt out of receiving any,
    ...
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;Users who generate a sale on Bazl will receive
      a 5% monetary reward for each transaction said user generates from their
      photo.
    </p>
    <p>
      Bazl App LLC facilitates the sale of content through the Bazl mobile app
      and is not responsible for the return, exchange, etc of any products.
    </p>
    <p>
    ...
    <p>
      Bazl LLC has the right but not the obligation to monitor and edit all
      Content provided by users.
    </p>
    <p>
      In addition, Content found on or through this Service are the property of
      Bazl LLC or used with permission. You may not distribute, modify,
    ...
    <h2 className="p-3">Links To Other Web Sites</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;Our Service may contain links to third party
      web sites or services that are not owned or controlled by Bazl LLC.
    </p>
    <p>
      Bazl LLC has no control over, and assumes no responsibility for the
      content, privacy policies, or practices of any third party web sites or
      services. We do not warrant the offerings of any of these
      entities/individuals or their websites.
    </p>
    <p>
      You acknowledge and agree that Bazl LLC shall not be responsible or
    ...
    <h2 className="p-3">Termination</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;We may terminate or suspend your account and
      bar access to the Service immediately, without prior notice or liability,
    ...
    <h2 className="p-3">Indemnification</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;
      {`You agree to defend, indemnify and hold
      harmless Bazl LLC and its licensee and licensors, and their employees,
      ...
      using your account and password; b) a breach of these Terms, or c) Content
      posted on the Service.`}
    </p>
    <h2 className="p-3">Limitation Of Liability</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;Bazl is only responsible for facilitating the
      purchase and sale of products. All returns, exchanges, etc must be
      communicated with and approved by the vendor.
    </p>
    <p>
      In no event shall Bazl LLC, nor its directors, employees, partners,
    ...
    <h2 className="p-3">Disclaimer</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;
    ...
    <p>
      Bazl LLC its subsidiaries, affiliates, and its licensors do not warrant
    ...
    <h2 className="p-3">Exclusions</h2>
    <p>
    ...
    <h2 className="p-3">Governing Law</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;These Terms shall be governed and construed in
      accordance with the laws of Florida, United States, without regard to its
    ...
    <h2 className="p-3">Changes</h2>
    <p>
      &nbsp; &nbsp; &nbsp; &nbsp;We reserve the right, at our sole discretion,
      to modify or replace these Terms at any time. If a revision is material we
      will provide at least 30 days notice prior to any new termstaking effect.
    ...
    <p>
      ...
      please contact us. admin@bazlapp.com
    </p>
  </>
);

const PrivacyPolicy = () => TermsConditions();

export { TermsConditions, PrivacyPolicy };
